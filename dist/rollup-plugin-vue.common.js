...
var compileSTYLUS = (function () {var _ref = _asyncToGenerator(_regeneratorRuntime.mark(function _callee(style, options) {var stylusObj, code, map;return _regeneratorRuntime.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                        stylusObj = stylus(style.code, _extends({}, options.stylus)).
                        set('filename', style.id).
                        set('sourcemap', {
                            'comment': false });_context.next = 3;return (


                            stylusObj.render());case 3:code = _context.sent;
...
function templateJs(script, template, lang, id, options, modules$$1) {
    ...
    if (matches && matches.length) {
        return script.split(matches[0]).join(matches[1] + '.options.template = ' + _JSON$stringify(template) + ';\n' + matches[0]);
    }
...
function renderJs(script, render, lang, id, options) {
    ...
    if (matches && matches.length) {
        ...
        var props = /module\.exports=(.*)$/.exec(renderScript)[1];
...
function moduleJs(script, modules$$1, lang, id, options) {
    ...
    if (matches && matches.length) {
        return script.split(matches[0]).join(matches[1] + '.options.cssModules = ' + _JSON$stringify(modules$$1) + ';\n' + matches[0]);
    }
...
var vueTransform = (function () {var _ref4 = _asyncToGenerator(_regeneratorRuntime.mark(function _callee4(code, id, options) {var nodes, css, modules$$1, js, isProduction, isWithStripped, style, _style, styleCode;return _regeneratorRuntime.wrap(function _callee4$(_context4) {while (1) {switch (_context4.prev = _context4.next) {case 0:
                        ...
                        style = css.map(function (s, i) {return 'import ' + _JSON$stringify('\0' + id + '.' + i + '.vue.component.' + s.lang) + ';';}).join(' ');return _context4.abrupt('return',
...
function vue() {var opts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    ...
    return {
        ...
        load: function load(id) {
            ...
            var parts = id.split('.');
            var component = parts.slice(0, parts.length - 4).join('.').slice(1);
